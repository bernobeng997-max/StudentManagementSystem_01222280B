...
public class ReportServiceTest {
    ...
    void topPerformersShouldReturnHighestGpaFirst() {
        ...
        assertEquals("014444444b", result.get(0).getStudentId());
    }
    ...
    void atRiskShouldReturnStudentsBelowThreshold() {
        ...
        assertEquals("01666666b", result.get(0).getStudentId());
    }

    @Test
    void gpaDistributionShouldGroupCorrectly() {

        repo.add(createStudent("S6", "CS", 200, 1.8));
        repo.add(createStudent("S7", "CS", 200, 2.5));
        repo.add(createStudent("S8", "CS", 200, 3.2));
        repo.add(createStudent("S9", "CS", 200, 3.8));
    ...
    void programmeSummaryShouldCountStudentsPerProgramme() {
        ...
        repo.add(createStudent("018888888b", "Computer Science", 300, 3.0));
        repo.add(createStudent("019999999b", "Computer Science", 200, 2.4));
        repo.add(createStudent("S10000000b", "IT", 400, 3.5));
