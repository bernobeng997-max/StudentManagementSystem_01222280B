...
public class StudentsController {
    ...
    public BorderPane view(){
        ...
        programmeFilter.getItems().addAll("All","Computer Engineering","Electrical Engineering","IT","Computer Science");
        ...
        date.setCellValueFactory(c ->
                new SimpleStringProperty(c.getValue().getDateAdded()));
        ...
        Runnable applyFilters = () -> {
            ...
            filtered.setPredicate(s -> {
                ...
                boolean matchLevel =
                        lvl == null
                                || lvl.equals("All")
                                || String.valueOf(s.getLevel()).equals(lvl);

                boolean matchProgramme =
                        progF == null
                                || progF.equals("All")
                                || s.getProgramme().equalsIgnoreCase(progF);

                boolean matchStatus =
                        stat == null
                                || stat.equals("All")
                                || s.getStatus().equalsIgnoreCase(stat);
        ...
        sortGpa.setOnAction(e -> table.getSortOrder().setAll(gpa));
        sortName.setOnAction(e -> table.getSortOrder().setAll(name));
